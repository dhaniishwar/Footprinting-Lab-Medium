...
>We can get the share folder on our local mechine by mounting it and send to the folder name 'target-nfs'.
...
&nbsp;
>Usually, the standard Windows share names end with '$'. We found two non-default shares Users and devshare
>Let's connect to devshare by username alex
